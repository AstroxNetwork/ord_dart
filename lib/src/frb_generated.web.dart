...
class OrdDartWire implements BaseWire {
  OrdDartWire.fromExternalLibrary(ExternalLibrary lib);
}

@JS('wasm_bindgen')
external OrdDartWasmModule get wasmModule;

@JS()
@anonymous
class OrdDartWasmModule implements WasmModule {
  @override
  external Object /* Promise */ call([String? moduleName]);

  @override
  external OrdDartWasmModule bind(dynamic thisArg, String moduleName);
}

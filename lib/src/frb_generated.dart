...
abstract class OrdDartApi extends BaseApi {
  ...
  int crateApiRuneEtchingMaxDivisibility({dynamic hint});

  int crateApiRuneEtchingMaxSpacers({dynamic hint});

  BigInt? crateApiRuneEtchingSupply({required Etching that, dynamic hint});

  Uint8List crateApiRuneRuneCommitment({required Rune that, dynamic hint});

  int crateApiRuneRuneFirstRuneHeight({required Network network, dynamic hint});

  Rune crateApiRuneRuneFromStr({required String s, dynamic hint});

  (BigInt, BigInt)? crateApiRuneRuneIdDelta(
      {required RuneId that, required RuneId next, dynamic hint});

  RuneId crateApiRuneRuneIdFromStr({required String s, dynamic hint});

  RuneId? crateApiRuneRuneIdNext(
      {required RuneId that,
      required BigInt block,
      required BigInt tx,
      dynamic hint});

  bool crateApiRuneRuneIsReserved({required Rune that, dynamic hint});

  Rune crateApiRuneRuneMinimumAtHeight(
      {required Network chain, required int height, dynamic hint});

  BigInt crateApiRuneRuneN({required Rune that, dynamic hint});

  Rune crateApiRuneRuneReserved(
      {required BigInt block, required int tx, dynamic hint});

  String crateApiRuneRuneToString({required Rune that, dynamic hint});

  int crateApiRuneRunestoneCommitConfirmations({dynamic hint});

  Artifact? crateApiRuneRunestoneDecipher(
      {required String rawTx, dynamic hint});

  Future<Artifact?> crateApiRuneRunestoneDecipherAsync(
      {required String rawTx, dynamic hint});

  Uint8List crateApiRuneRunestoneEncipher(
      {required Runestone that, dynamic hint});

  Future<Uint8List> crateApiRuneRunestoneEncipherAsync(
      {required Runestone that, dynamic hint});

  int crateApiRuneRunestoneMagicNumber({dynamic hint});

  SpacedRune crateApiRuneSpacedRuneFromStr({required String s, dynamic hint});

  String crateApiRuneSpacedRuneToString(
      {required SpacedRune that, dynamic hint});
}
...
class OrdDartApiImpl extends OrdDartApiImplPlatform implements OrdDartApi {
  ...
  @override
  int crateApiRuneRuneFirstRuneHeight(
      {required Network network, dynamic hint}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
